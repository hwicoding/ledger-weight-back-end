...
#### 1.2 게임 시작 프로토콜
- [x] `START_GAME` 메시지 타입 처리 (2025-12-12 완료)
...
#### 1.3 AI 플레이어 추가 기능
- [x] `ADD_AI_PLAYER` 메시지 타입 처리 (2025-12-12 완료)
- [x] Player 모델에 `isBot` 필드 추가
- [x] GameManager에 AI 플레이어 추가 메서드 구현
- [x] 난이도별 AI 플레이어 이름 생성
- [x] 검증 로직 및 에러 처리
- [x] 게임 상태 브로드캐스트
- [x] 테스트 완료 (최소 인원 충족 및 게임 시작 테스트)
